...
Adafruit_NeoPixel tira = Adafruit_NeoPixel(6, 23, ((1 << 6) | (1 << 4) | (0 << 2) | (2)) /*|< Transmit as G,R,B*/ + 0x0000 /*|< 800 KHz data transmission*/);
...
void pulsoRelay()
{
    digitalWrite(pinRelay, 0x1);
    delay(500);
    digitalWrite(pinRelay, 0x0);
}
